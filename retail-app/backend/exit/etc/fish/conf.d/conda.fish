set -gx CONDA_EXE "/home/gleb/smart-retail-project/retail-app/backend/exit/bin/conda";
set -gx _CONDA_EXE "/home/gleb/smart-retail-project/retail-app/backend/exit/bin/conda";
set -e _CE_M || true;
set -e _CE_CONDA || true;
set -gx CONDA_PYTHON_EXE "/home/gleb/smart-retail-project/retail-app/backend/exit/bin/python";
set -gx _CONDA_ROOT "/home/gleb/smart-retail-project/retail-app/backend/exit";
