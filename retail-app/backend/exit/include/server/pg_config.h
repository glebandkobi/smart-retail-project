...
#define CONFIGURE_ARGS " '--prefix=/home/gleb/smart-retail-project/retail-app/backend/exit' '--with-readline' '--with-libraries=/home/gleb/smart-retail-project/retail-app/backend/exit/lib' '--with-includes=/home/gleb/smart-retail-project/retail-app/backend/exit/include' '--with-openssl' '--with-gssapi' '--with-icu' '--with-libxml' '--with-libxslt' '--with-lz4' '--with-zstd' '--with-uuid=e2fs' '--with-system-tzdata=/home/gleb/smart-retail-project/retail-app/backend/exit/share/zoneinfo' '--with-ldap' 'PG_SYSROOT=undefined' 'build_alias=x86_64-conda-linux-gnu' 'host_alias=x86_64-conda-linux-gnu' 'CC=x86_64-conda-linux-gnu-cc' 'CFLAGS=-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /home/gleb/smart-retail-project/retail-app/backend/exit/include -fdebug-prefix-map=/home/task_176970571454880/croot/postgresql-split_1769705818347/work=/usr/local/src/conda/postgresql-split-17.6 -fdebug-prefix-map=/home/gleb/smart-retail-project/retail-app/backend/exit=/usr/local/src/conda-prefix' 'LDFLAGS=-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/home/gleb/smart-retail-project/retail-app/backend/exit/lib -Wl,-rpath-link,/home/gleb/smart-retail-project/retail-app/backend/exit/lib -L/home/gleb/smart-retail-project/retail-app/backend/exit/lib' 'CPPFLAGS=-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/gleb/smart-retail-project/retail-app/backend/exit/include' 'CXX=' 'CPP=/home/task_176970571454880/croot/postgresql-split_1769705818347/_build_env/bin/x86_64-conda-linux-gnu-cpp' 'PKG_CONFIG_PATH=/home/gleb/smart-retail-project/retail-app/backend/exit/lib/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 17.6 on x86_64-conda-linux-gnu, compiled by x86_64-conda-linux-gnu-cc (GCC) 14.3.0, 64-bit"
